use std::io;  // библиотека работы с вводом/выводом
use std::mem; // библиотека работы с памятью


fn code () {
    let mut input = String::new(); // создание пустой перменной string
    io::stdin().read_line(&mut input); // ввод значения с клавиатуры и запись в input
    // создание двух векторов <char>
